...
type _ModelsAccount ModelsAccount
...
func (o *ModelsAccount) UnmarshalJSON(data []byte) (err error) {
	...
	varModelsAccount := _ModelsAccount{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varModelsAccount)

	if err != nil {
		return err
	}

	*o = ModelsAccount(varModelsAccount)
